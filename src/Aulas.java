...
public class Aulas {
    private static final String URL = "jdbc:sqlite:C:\\Users\\LabInfo\\Documents\\juleandro\\facul.db";
    ...
    public void createTable() {
        try (Statement statement = connection.createStatement()) {
            statement.execute("CREATE TABLE IF NOT EXISTS Aulas (ID INTEGER PRIMARY KEY, Nome VARCHAR, Idade INTEGER)");
            connection.commit();
    ...
    public void insertAlunos(List<String[]> lista) {
        try (PreparedStatement insertStatement = connection.prepareStatement("INSERT INTO Alunos(Nome, Idade) VALUES(?, ?)")) {
            for (String[] s : lista) {
